...
/***/ "./resources/js/gridjs/gridjs.umd.js":
/*!*******************************************!*\
  !*** ./resources/js/gridjs/gridjs.umd.js ***!
  \*******************************************/
...
!function (t, n) {
  ...
  function n(t, n) {
    for (var e = 0; e < n.length; e++) {
      var r = n[e];
      r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(t, "symbol" == _typeof(o = function (t, n) {
  ...
  function Y(t, n) {
    if (_typeof(t) != _typeof(n)) return !1;
      ...
      return o(n, t), n.prototype._process = function (t) {
        return this.props.keyword ? (n = String(this.props.keyword).trim(), e = this.props.columns, r = this.props.ignoreHiddenColumns, o = t, i = this.props.selector, n = n.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), new J(o.rows.filter(function (t, o) {
          return t.cells.some(function (t, u) {
            if (!t) return !1;
            if (r && e && e[u] && "object" == _typeof(e[u]) && e[u].hidden) return !1;
            var s = "";
            if ("function" == typeof i) s = i(t.data, o, u);else if ("object" == _typeof(t.data)) {
              var a = t.data;
  ...
  var Kt = /*#__PURE__*/function (n) {
      ...
      return u.adjustWidth = function (t, n, e) {
        ...
        for (var e, o = a(n || this.columns || []); !(e = o()).done;) {
          var i = e.value;
          i.columns && i.columns.length > 0 ? i.sort = void 0 : void 0 === i.sort && t ? i.sort = {} : i.sort ? "object" == _typeof(i.sort) && (i.sort = r({}, i.sort)) : i.sort = void 0, i.columns && this.setSort(t, i.columns);
        }
        ...
        for (var n, e = new i(), r = a(t); !(n = r()).done;) {
          ...
          if ("string" == typeof o || d(o)) e.columns.push({
            ...
            var u = o;
            u.columns && (u.columns = i.fromColumns(u.columns).columns), "object" == _typeof(u.plugin) && void 0 === u.data && (u.data = null), e.columns.push(o);
          }
        }
        return e;
      }, i.createFromConfig = function (t) {
        var n = new i();
        return t.from ? n.columns = i.fromHTMLTable(t.from).columns : t.columns ? n.columns = i.fromColumns(t.columns).columns : !t.data || "object" != _typeof(t.data[0]) || t.data[0] instanceof Array || (n.columns = Object.keys(t.data[0]).map(function (t) {
          return {
            name: t
          };
  ...
  var rn = /*#__PURE__*/function (t) {
    ...
    an = /*#__PURE__*/function (t) {
      ...
      return r.castData = function (t) {
        ...
        }) : "object" != _typeof(t[0]) || t[0] instanceof Array ? [] : t.map(function (t) {
  ...
  function wn(t) {
    var n = It(),
      ...
      c = "object" == _typeof(null == a ? void 0 : a.server) ? K.ServerSort : K.Sort,
      f = function f() {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/gridjs/gridjs.umd.js");
/******/ 	
/******/ })()
;