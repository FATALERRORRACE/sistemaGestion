...
/***/ "./resources/js/consultarInscritos.js":
/*!********************************************!*\
  !*** ./resources/js/consultarInscritos.js ***!
  \********************************************/
...
/* harmony export */   ConsultarInscritos: () => (/* binding */ ConsultarInscritos)
/* harmony export */ });
...
var ConsultarInscritos = /*#__PURE__*/function () {
  function ConsultarInscritos() {
    _classCallCheck(this, ConsultarInscritos);
    _defineProperty(this, "newOrEdit", "new");
...

    {
      ...
      formatter: function formatter(_, row) {
        return (0,gridjs__WEBPACK_IMPORTED_MODULE_1__.html)("<div class=\"flex justify-center\">\n                    <button class=\"py-1 px-2 rounded-md text-white bg-invented-300  btn-sm mx-1 hover:bg-green-600\" onclick=\"formSeguimiento\">\n                        Seguimiento\n                    </button>\n                    <button class=\"bg-009F4D py-1 px-2 rounded-md text-white  btn-sm hover:bg-blue-700\" onclick=\"formSeguimiento(".concat(row._cells[0].data, ")\">\n                        Formulario\n                    </button>\n                </div>"));
      }
    }]);
  }
  return _createClass(ConsultarInscritos, [{
    key: "qrGenerate",
    value: function () {
      var _qrGenerate = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(activeSubMenu) {
        var classContext;
      ...
      function qrGenerate(_x) {
        return _qrGenerate.apply(this, arguments);
      }
      return qrGenerate;
    }()
  }, {
    key: "jqActions",
    value: function () {
      var _jqActions = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(text) {
        var classContext;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              classContext = this;
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dialog-form").html(text);
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dialog-form").dialog({
                autoOpen: false,
                position: {
                  my: "top",
                  at: "bottom",
                  of: jquery__WEBPACK_IMPORTED_MODULE_0___default()('#contain-e-t')
                },
                height: 'auto',
                width: '40em',
                modal: false,
                open: function open(event, ui) {
                  ...
                  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#contain-e-t').css({
                    "z-index": "1000"
                  });
                },
              ...
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#close-biblioteca-dialog").click(function () {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dialog-form").dialog('close');
              });
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dialog-form").dialog('open');
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").off('change.qr');
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").on('change.qr', function (ev) {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#qr-content").html("<a href=\"api/qr/donwload/".concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").val(), "/png\" class=\"rounded-lg base-1-color btn-sm p-2 mx-1 border-2 border-bblr-1 \" download=\"\">Descargar .PNG</a>\n                <a href=\"api/qr/donwload/").concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").val(), "/pdf\" class=\"rounded-lg base-1-color btn-sm p-2 mx-1 border-2 border-bblr-1 \" download=\"\">Descargar .PDF</a>\n                <a href=\"http://afiliacion.biblored.net/afiliacion/admin/qrcodes/").concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").val(), ".png\" class=\"rounded-lg base-1-color btn-sm p-2 mx-1 border-2 border-bblr-1 \" Target=\"_blank\">Link a la imagen</a>\n                <div class=\"p-2 w-100\">\n                    <img style=\"w-100\" src=\"http://afiliacion.biblored.net/afiliacion/admin/qrcodes/").concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").val(), ".png\">\n                </div>"));
              });
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").trigger('change.qr');
            case 8:
            case "end":
      ...
      function jqActions(_x2) {
        return _jqActions.apply(this, arguments);
      }
      return jqActions;
    }()
  }, {
    key: "renderFindRegistered",
    value: function renderFindRegistered() {
      var _this = this;
      fetch("api/inscritos/view", {
        ...
        return response.text().then(function (text) {
          _this.renderFindRegisteredUtils(text);
        });
      });
    }
  }, {
    key: "renderFindRegisteredUtils",
    value: function renderFindRegisteredUtils(text) {
      var instance = this;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#tableContent").html(text);
      var urlParams = "?documento=".concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#documento").val(), "&\n            nombres=").concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#nombres").val(), "&\n            apellidos=").concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#apellidos").val(), "&\n            email=").concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#email").val(), "&\n            consecutivo=").concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").val(), "&\n            consecutivonm=").concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio option:selected").text());
      gridInstance = new gridjs__WEBPACK_IMPORTED_MODULE_1__.Grid({
        ...
        pagination: true,
        server: {
          url: "/api/inscritos/".concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#espacio').val(), "/get").concat(urlParams),
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").off('change.inscritos').off('change.utilsespacio').off('change.qr');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").on('change.inscritos', function (ev) {
...
var Prestamos = /*#__PURE__*/function () {
  function Prestamos() {
    _classCallCheck(this, Prestamos);
    _defineProperty(this, "columns", [{
      id: "id",
      name: "Teléfono (s)",
      width: '60px'
      ...
      id: "email",
      name: "Título del material",
      width: '150px'
    }, {
      id: "biblioteca",
      name: "Autor del material",
      width: '150px'
    }, {
      id: "privilegios",
      ...
      name: 'Acción',
      width: '50px',
      //onclick="editUser(${row._cells[0].data})"
      formatter: function formatter(_, row) {
        return (0,gridjs__WEBPACK_IMPORTED_MODULE_0__.html)("<div class=\"flex justify-center\">\n                    <button class=\"py-1 px-2 border rounded-md text-white bg-invented-300\" >\n                        <i class=\"fa-solid fa-check\"></i> Validar\n                    </button>\n                </div>");
      }
    }]);
  }
  return _createClass(Prestamos, [{
    key: "render",
    value: function () {
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              gridInstance.updateConfig({
                columns: instance.columns,
                server: {
                  url: "/api/prestamos/".concat(jquery__WEBPACK_IMPORTED_MODULE_2___default()('#espacio').val(), "/get"),
                  then: function then(data) {
                    return data.data;
                  },
                  total: function total(data) {
            ...
            case 5:
              ...
              return new gridjs__WEBPACK_IMPORTED_MODULE_0__.Grid({
                ...
                sort: true,
                pagination: true,
                language: gridjs_l10n__WEBPACK_IMPORTED_MODULE_1__.esES,
                resizable: true,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Seguimiento: () => (/* binding */ Seguimiento)
/* harmony export */ });
/* harmony import */ var gridjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gridjs */ "./node_modules/gridjs/dist/gridjs.module.js");
/* harmony import */ var gridjs_l10n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gridjs/l10n */ "./node_modules/gridjs/l10n/dist/l10n.module.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
/* harmony import */ var jquery_ui_ui_widgets_tabs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! jquery-ui/ui/widgets/tabs */ "./node_modules/jquery-ui/ui/widgets/tabs.js");
...
var Seguimiento = /*#__PURE__*/function () {
  ...
  return _createClass(Seguimiento, [{
    key: "render",
    value: function () {
      var _render = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _this = this;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              instance = this;
              jquery__WEBPACK_IMPORTED_MODULE_2___default()("#tableContent").empty();
              jquery__WEBPACK_IMPORTED_MODULE_2___default()('#espacio').off('change.usuariosespacio');
              jquery__WEBPACK_IMPORTED_MODULE_2___default()('#espacio').on('change.seguimientoespacio', function () {
                //get data for grid
                gridInstance.updateConfig({
                  columns: _this.columns,
                  server: {
                    url: "/api/registro/".concat(jquery__WEBPACK_IMPORTED_MODULE_2___default()('#espacio').val(), "/get"),
                    then: function then(data) {
                      return data.data;
                    },
                    total: function total(data) {
              ...
              if (gridInstance !== undefined) gridInstance.updateConfig({
                columns: this.columns,
                server: {
                  url: "/api/registro/".concat(jquery__WEBPACK_IMPORTED_MODULE_2___default()('#espacio').val(), "/get"),
                  then: function then(data) {
              ...
              }).forceRender();else gridInstance = new gridjs__WEBPACK_IMPORTED_MODULE_0__.Grid({
                className: {
                  tr: 'table-tr-custom'
                },
                columns: this.columns,
    ...
    key: "instanceGrid",
    value: function () {
      var _instanceGrid = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              jquery__WEBPACK_IMPORTED_MODULE_2___default()("#dialog-form").dialog({
                autoOpen: false,
                height: 'auto',
                width: '55em',
                modal: true,
      ...
      function instanceGrid() {
        return _instanceGrid.apply(this, arguments);
      }
      return instanceGrid;
    }()
  }, {
    key: "createModalCreateUser",
    value: function () {
      var _createModalCreateUser = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      ...
      function createModalCreateUser() {
        return _createModalCreateUser.apply(this, arguments);
      }
      return createModalCreateUser;
    }()
  }, {
    key: "actionsNewUserModal",
    value: function actionsNewUserModal() {
      fetch("api/users/view/new", {
        ...
        return response.text().then(function (text) {
          jquery__WEBPACK_IMPORTED_MODULE_2___default()(".ui-dialog-title").text("Nuevo Usuario");
          jquery__WEBPACK_IMPORTED_MODULE_2___default()("#dialog-form").html(text);
          jquery__WEBPACK_IMPORTED_MODULE_2___default()("#dialog-form").dialog("open");
          jquery__WEBPACK_IMPORTED_MODULE_2___default()("#place-txt").val(jquery__WEBPACK_IMPORTED_MODULE_2___default()("#espacio option:selected").text());
          jquery__WEBPACK_IMPORTED_MODULE_2___default()("#nubiblioteca").val(jquery__WEBPACK_IMPORTED_MODULE_2___default()("#espacio").val());
          jquery__WEBPACK_IMPORTED_MODULE_2___default()("#save-new-user").off().on('click.save-newuser', function () {
            var dataNewUser = {};
            jquery__WEBPACK_IMPORTED_MODULE_2___default()("#nu-form").serializeArray().forEach(function (element) {
            ...
            fetch("/api/users", {
              ...
              return response.json().then(function (json) {
                jquery__WEBPACK_IMPORTED_MODULE_2___default()("#dialog-form").dialog('close');
                jquery__WEBPACK_IMPORTED_MODULE_2___default()("#espacio").trigger("change");
                if (json.status == 'ok') {
                  toastr__WEBPACK_IMPORTED_MODULE_5___default().success(json.message);
                } else {
                  toastr__WEBPACK_IMPORTED_MODULE_5___default().error(json.message);
                }
              });
            });
          });
          jquery__WEBPACK_IMPORTED_MODULE_2___default()("#close-dialog").click(function () {
            jquery__WEBPACK_IMPORTED_MODULE_2___default()("#dialog-form").dialog('close');
          });
        });
      });
...
// GLOBAL FUNCTIONS
window.formSeguimiento = function (idSeguimiento) {
  fetch("api/registro/form/".concat(idSeguimiento), {
    method: "GET",
    headers: headers,
    redirect: "follow"
  }).then(function (response) {
    return response.text().then(function (text) {
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(".ui-dialog-title").text("INFORMACIÓN DEL AFILIADO");
      jquery__WEBPACK_IMPORTED_MODULE_2___default()("#dialog-form").html(text);
      jquery__WEBPACK_IMPORTED_MODULE_2___default()("#dialog-form").dialog("open");
      jquery__WEBPACK_IMPORTED_MODULE_2___default()("#tabs").tabs();
      jquery__WEBPACK_IMPORTED_MODULE_2___default()("#localidad").select2();
      jquery__WEBPACK_IMPORTED_MODULE_2___default()("#diremuni").select2();
...
var Usuarios = /*#__PURE__*/function () {
  function Usuarios() {
    ...
    _defineProperty(this, "columns", [{
      ...
      width: '60px',
      formatter: function formatter(cell) {
        return (0,gridjs__WEBPACK_IMPORTED_MODULE_0__.html)(cell == 1 ? "<span class=\"text-emerald-600\">Activo</span>" : "<span class=\"text-red-400\">Inactivo</span>");
      }
    }, {
      name: 'Acción',
      width: '50px',
      ...
      var _instanceGrid = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 8:
              gridInstance = _context2.sent;
            case 9:
              _context2.next = 11;
              return this.createModalCreateUser();
            case 11:
              jquery__WEBPACK_IMPORTED_MODULE_2___default()('#espacio').off('change.seguimientoespacio');
              jquery__WEBPACK_IMPORTED_MODULE_2___default()('#espacio').on('change.usuariosespacio', function (ev) {
                //get data for grid
                if (ev.currentTarget.value != undefined && ev.currentTarget.value != '') {
                  fetch("api/users/".concat(ev.currentTarget.value, "/get"), {
                    method: "GET",
                    headers: headers,
                    redirect: "follow"
                  }).then(function (response) {
      ...
      var _createModalCreateUser = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              classEnv = this;
              jquery__WEBPACK_IMPORTED_MODULE_2___default()(".gridjs-head").append("<button id=\"create-user\" class=\"px-3 mx-3 base-1-color btn rounded-lg p-2\"><i class=\"fa-solid fa-plus\"></i><i class=\"fa-solid fa-user\"></i></button>");
              jquery__WEBPACK_IMPORTED_MODULE_2___default()("#create-user").off().on("click", function () {
            ...
            fetch("/api/users", {
              ...
              return response.json().then(function (json) {
                ...
                if (json.status == 'ok') {
                  ...
                  toastr__WEBPACK_IMPORTED_MODULE_4___default().error(json.message);
                }
              });
            });
          });
...
// GLOBAL FUNCTIONS
window.editUser = function (idUser) {
  fetch("api/users/view/".concat(idUser, "/edit"), {
    method: "GET",
    headers: headers,
    redirect: "follow"
  }).then(function (response) {
    return response.text().then(function (text) {
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(".ui-dialog-title").text("Editar Usuario");
      jquery__WEBPACK_IMPORTED_MODULE_2___default()("#dialog-form").html(text);
      jquery__WEBPACK_IMPORTED_MODULE_2___default()("#dialog-form").dialog("open");
      jquery__WEBPACK_IMPORTED_MODULE_2___default()("#save-change-user").off().click(function () {
        var dataNewUser = {};
        jquery__WEBPACK_IMPORTED_MODULE_2___default()("#nu-form").serializeArray().forEach(function (element) {
          dataNewUser[element.name] = element.value;
        });
        if (jquery__WEBPACK_IMPORTED_MODULE_2___default()("#id-edit").val() != undefined) {
          fetch("/api/users/".concat(jquery__WEBPACK_IMPORTED_MODULE_2___default()("#id-edit").val(), "/edit"), {
            method: "POST",
            headers: headers,
            body: JSON.stringify(dataNewUser)
          }).then(function (response) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default()("#close-dialog").off().click(function () {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()("#dialog-form").dialog('close');
      });
    });
  });
...
/* harmony import */ var jquery_ui_ui_widgets_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! jquery-ui/ui/widgets/dialog */ "./node_modules/jquery-ui/ui/widgets/dialog.js");
/* harmony import */ var jquery_ui_ui_widgets_dialog__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(jquery_ui_ui_widgets_dialog__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var jquery_ui_ui_effects_effect_highlight__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! jquery-ui/ui/effects/effect-highlight */ "./node_modules/jquery-ui/ui/effects/effect-highlight.js");
/* harmony import */ var jquery_ui_ui_effects_effect_highlight__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(jquery_ui_ui_effects_effect_highlight__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var toastr__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! toastr */ "./node_modules/toastr/toastr.js");
/* harmony import */ var toastr__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(toastr__WEBPACK_IMPORTED_MODULE_4__);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator["return"] && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, "catch": function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
...
var Utilities = /*#__PURE__*/function () {
  ...
  return _createClass(Utilities, [{
      ...
      var _render = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              if (defaultAccess) {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#acceso-".concat(defaultAccess)).prop("checked", true);
                fetch("/api/libraries/get?type=".concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#acceso-".concat(defaultAccess)).val()), {
                  method: "GET",
                  headers: headers,
                  redirect: "follow"
                }).then(function (response) {
              ...
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-by-menu").select2();
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#filter-submenu").click(function () {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#filter-menu-dropdown").data("open");
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#filter-menu-dropdown").css({
                  'display': "block"
                }).data("open", 1);
              });
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#close-submenu-filter").click(function () {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#filter-menu-dropdown").css({
                  'display': "none"
                }).data("open", 0);
              });
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-by-menu").change(function (eveS) {
                if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#filter-menu-dropdown").data("open") == 1) {
                  ...
                  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + eveS.currentTarget.value).trigger('click');
                  var parent = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + eveS.currentTarget.value).parent();
                  do {
                    if (parent[0].localName == 'ul') {
                      parent.fadeIn(400);
                      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + eveS.currentTarget.value).effect('highlight', {}, 1500);
                    }
                    ;
              ...
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-by-menu").closest('.list_product').css({
                'display': "block"
              });
            case 7:
            case "end":
    ...
    key: "biblioteca",
    value: function () {
      var _biblioteca = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(activeSubMenu) {
        var classContext;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
            ...
            case 4:
              ;
              _context2.next = 7;
              return fetch("api/biblioteca/form", {
                method: "GET",
                headers: headers,
                redirect: "follow"
              }).then(function (response) {
      ...
      function biblioteca(_x) {
        return _biblioteca.apply(this, arguments);
      }
      return biblioteca;
    }()
  }, {
    key: "jqActions",
    value: function () {
      var _jqActions = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(text) {
        var _this = this;
        var classContext;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              classContext = this;
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sub-content").html(text);
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dialog-bbltc").dialog({
                autoOpen: false,
                position: {
                  my: "top",
                  at: "bottom",
                ...
                open: function open(event, ui) {
                  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".ui-dialog-title").text('');
                  setTimeout(function () {
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#modal-mask").css({
                      'display': 'block'
                    });
                  }, 200);
              ...
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#close-biblioteca-dialog").click(function () {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dialog-bbltc").dialog('close');
              });
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dialog-bbltc").dialog('open');
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#new-library").off().click(function () {
                classContext.ChangeActiveInactive("new", "edit");
                jquery__WEBPACK_IMPORTED_MODULE_0___default()('#contain-e-t').css({
                  "z-index": "10"
                });
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#biblioteca").val('');
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#carne").val('');
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#codigo").val('');
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#impresion").prop("checked", false);
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#publico").prop("checked", false);
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#localidad").val('').trigger("change");
              });
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").on('change.utilsespacio', function (ev) {
                if (_this.newOrEdit == 'new') return;
                if (ev.currentTarget.value < 0) {
                  toastr__WEBPACK_IMPORTED_MODULE_4___default().warning('Selecciona el Espacio a Editar');
                  return;
                }
                fetch("api/biblioteca/".concat(ev.currentTarget.value), {
                  method: "GET",
                  headers: headers
                }).then(function (response) {
                  return response.json().then(function (json) {
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#biblioteca").val(json.biblioteca);
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#carne").val(json.carne);
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#codigo").val(json.codigo);
                    if (json.impresion == 1) jquery__WEBPACK_IMPORTED_MODULE_0___default()("#impresion").prop("checked", true);else jquery__WEBPACK_IMPORTED_MODULE_0___default()("#impresion").prop("checked", false);
                    if (json.publico_escolar == 1) jquery__WEBPACK_IMPORTED_MODULE_0___default()("#publico").prop("checked", true);else jquery__WEBPACK_IMPORTED_MODULE_0___default()("#publico").prop("checked", false);
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#localidad").val(json.localidad).trigger("change");
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#bbltcacceso-".concat(json.tipo)).prop("checked", true);
                  });
                });
              });
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#edit-library").click(function (eve) {
              ...
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#localidad").select2();
              this.saveActions();
            case 10:
            case "end":
              return _context3.stop();
    ...
    key: "saveActions",
    value: function () {
      var _saveActions = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var _this2 = this;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#save-biblioteca").off().click(function () {
                var url = _this2.newOrEdit == 'edit' ? "/api/biblioteca/".concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").val()) : "api/biblioteca";
                var dataNewUser = {};
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#biblioteca-form").serializeArray().forEach(function (element) {
                  dataNewUser[element.name] = element.value;
                });
                fetch(url, {
                  method: "POST",
                  ...
                  return response.json().then(function (json) {
                    if (json.status == 'ok') {
                      toastr__WEBPACK_IMPORTED_MODULE_4___default().success(json.message);
                      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#acceso-".concat(json.tipo)).prop("checked", true);
                      fetch("/api/libraries/get?type=".concat(json.tipo), {
                        method: "GET",
                        headers: headers,
                        redirect: "follow"
                      }).then(function (response) {
                        return response.json().then(function (jsonLibrary) {
                          jsonLibrary.unshift({
                            id: -1,
                            text: 'Seleccione el Espacio'
                          });
                          ...
                          jquery__WEBPACK_IMPORTED_MODULE_0___default()("#espacio").val(json.id).trigger('change');
                        });
                      });
                      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dialog-bbltc").dialog('close');
                    } else {
      ...
      function saveActions() {
        return _saveActions.apply(this, arguments);
      }
      return saveActions;
    }()
  }, {
    key: "ChangeActiveInactive",
    value: function () {
      var _ChangeActiveInactive = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(active, inactive) {
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#".concat(active, "-library")).removeClass('hover:bg-slate-500 bg-slate-200').addClass('hover:bg-blue-700 bg-blue-600');
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#".concat(inactive, "-library")).removeClass('hover:bg-blue-700 bg-blue-600').addClass('hover:bg-slate-500 bg-slate-200');
      ...
      function ChangeActiveInactive(_x3, _x4) {
        return _ChangeActiveInactive.apply(this, arguments);
      }
      return ChangeActiveInactive;
    }()
  }, {
    key: "bibliotecaInitBefore",
    value: function () {
      var _bibliotecaInitBefore = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
      ...
      function bibliotecaInitBefore() {
        return _bibliotecaInitBefore.apply(this, arguments);
      }
      return bibliotecaInitBefore;
    }()
  }]);
}();
...
"use strict";
/*!************************************!*\
  !*** ./resources/js/btnActions.js ***!
  \************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _usuarios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./usuarios */ "./resources/js/usuarios.js");
/* harmony import */ var _seguimiento__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./seguimiento */ "./resources/js/seguimiento.js");
...
/* harmony import */ var _consultarInscritos__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./consultarInscritos */ "./resources/js/consultarInscritos.js");
...
jquery__WEBPACK_IMPORTED_MODULE_5___default()(document).ready(function () {
  instanceUtils = new _utils__WEBPACK_IMPORTED_MODULE_2__.Utilities();
  instanceUtils.render();
  jquery__WEBPACK_IMPORTED_MODULE_5___default()('.dropdown-item').click(function (ev) {
    instanceUsers, instanceSeguimiento, prestamosInstance = null; // clean previous instances to not load to much cpu
  });
  jquery__WEBPACK_IMPORTED_MODULE_5___default()('#submenu-78').click(function (ev) {
    if (activeMenu == 'usuarios') return;
    instanceUsers = new _usuarios__WEBPACK_IMPORTED_MODULE_0__.Usuarios();
    instanceUsers.render();
    activeMenu = 'usuarios';
  });
  jquery__WEBPACK_IMPORTED_MODULE_5___default()('#submenu-82').click(function (ev) {
    instanceUtils.biblioteca(activeSubMenu);
    activeSubMenu = "biblioteca";
  });
  jquery__WEBPACK_IMPORTED_MODULE_5___default()('#submenu-58').click(function (ev) {
    if (activeMenu == 'seguimiento') return;
    instanceSeguimiento = new _seguimiento__WEBPACK_IMPORTED_MODULE_1__.Seguimiento();
    instanceSeguimiento.render();
    activeMenu = "seguimiento";
  });
  jquery__WEBPACK_IMPORTED_MODULE_5___default()('#submenu-91').click(function (ev) {
    if (activeMenu == 'prestamos') return;
    prestamosInstance = new _prestamos__WEBPACK_IMPORTED_MODULE_3__.Prestamos();
    prestamosInstance.render();
    activeMenu = "prestamos";
  });
  jquery__WEBPACK_IMPORTED_MODULE_5___default()('#submenu-15').click(function (ev) {
    if (!consultarInscritos) consultarInscritos = new _consultarInscritos__WEBPACK_IMPORTED_MODULE_4__.ConsultarInscritos();
    consultarInscritos.qrGenerate(activeSubMenu);
    activeSubMenu = "QrCode";
  });
  jquery__WEBPACK_IMPORTED_MODULE_5___default()('#submenu-12').click(function (ev) {
